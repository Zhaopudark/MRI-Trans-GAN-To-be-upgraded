...
if __name__ == "__main__":
    ...
    a = DataPipeLine("G:\\Datasets\\BraTS\\ToCrop\\",target_size=[196,196],remake_flag=True,random_flag=False)
    for i,(t1,t2) in enumerate(a.generator()):
        print(i,t1.shape,t1.dtype,
                t2.shape,t2.dtype,
                t1.max(),t1.min(),
                t2.max(),t2.min())
    a = DataPipeLine("G:\\Datasets\\BraTS\\ToCrop\\",target_size=[128,128,128],remake_flag=True,random_flag=False)
    for i,(t1,t2) in enumerate(a.generator()):
        print(i,t1.shape,t1.dtype,
                t2.shape,t2.dtype,
                t1.max(),t1.min(),

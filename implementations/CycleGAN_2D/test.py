...
import datasets.BratsPipeLine2 as train_dataset
...
tmp_path = "D:/Work/Codes_tmp/2DCycleGAN-mixed-wgp-sn-randomCrop128-noMask-v64"
out_path = "D:/Work/Codes_tmp/2DCycleGAN-mixed-wgp-sn-randomCrop128-noMask-v64/out" #64v(default) 72v 96v 128v 32v 24v
...
#     plt.axis('off')
#     plt.show()
test_set = train_dataset.DataPipeLine(test_path,target_size=[240,240],patch_size=[128,128],test_flag=True)

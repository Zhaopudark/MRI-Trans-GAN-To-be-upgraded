...
"""
global_input_X_shape = [1,128,128,16,1]
global_input_Y_shape = [1,128,128,16,1]
global_mask_X_shape = [1,128,128,16,1]
global_mask_Y_shape = [1,128,128,16,1]
################################################
class CycleGAN(tf.keras.Model):
    ...
    def get_seed(self):
        ...
        plt.imshow(testX[0,:,:,8,0],cmap='gray')
        plt.show()
        plt.imshow(testY[0,:,:,8,0],cmap='gray')
        plt.show()
        plt.imshow(maskX[0,:,:,8,0],cmap='gray')
        plt.show()
        plt.imshow(maskY[0,:,:,8,0],cmap='gray')
        plt.show()
    ...
    def wirte_summary(self,step,seed,G,F,G_loss,Dy_loss,F_loss,Dx_loss,out_path):
        ...
        maskX=maskX[:,:,:,8,:]
        maskY=maskY[:,:,:,8,:]
        GeneratedY=GeneratedY[:,:,:,8,:]
        GeneratedX=GeneratedX[:,:,:,8,:]
    ...
    def test(self):
        ...
        rows = result_buf
        with open(out_path+'/result.csv','w')as f:
            f_csv = csv.writer(f)
